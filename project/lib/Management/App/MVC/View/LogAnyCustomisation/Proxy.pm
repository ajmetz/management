...
package Management::App::MVC::View::LogAnyCustomisation::Proxy;

# ABSTRACT: Log::Any generator proxy object
our $VERSION = '1.719'; # AJM - 21/Apr/2026 - based off of this Log::Any::Proxy version.
...
characters.
    ...
    use utf8;
    use Log::Any qw( $log );
    my @data = ( "ÐŸÑ€Ð¸Ð²ÐµÑ‚ Ð¼Ð¸Ñ€" ); # Hello, World!
